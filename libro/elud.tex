...
A efectos de notación, se utilizan para el ud los mismos símbolos que acostumbran a emplearse para la guitarra, y que tienen su origen en la música escrita para violín, en la que indican la dirección del arco. La pulsación descendente se indica con el símbolo \scalerel*{\includegraphics{downbow.png}}{B}, mientras que la ascendente se denota con el símbolo \scalerel*{\includegraphics{upbow.png}}{B}. En ocasiones (es habitual en ciertos contextos como el de la música persa), la pulsación descendente puede aparecer indicada con el símbolo \scalerel*{\includegraphics{downbow2.png}}{B}. En este texto sólo utilizaremos la primera de estas formas, por ser la más extendida.
