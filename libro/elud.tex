...
El estilo de ud persa, al igual que el iraquí, es más reposado que el árabe. Se basa en el estudio del denominado \emph{radif}, una corpus de motivos melódicos que se transmiten de generación en generación y que se han de memorizar de manera precisa. Este enfoque musical difiere notablemente del estilo árabe, y sus fundamentos teóricos quedan fuera de lo que cubre este texto.
