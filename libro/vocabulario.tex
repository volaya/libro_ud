...
\begin{lilypond}
    ...
    notes = \relative {
    	\key do \rast
    	\time 16/4
        do16\downbow do do do do do do do do, \downbow do'\downbow do do do do do do 
        \bar "||"
    }
...
Un ejemplo similar en \maqam Rast.

***

\audioclip{inicio_con_frase_bayati.mp3}{Inicio con frase antes de llegar a tónica (Rast)}
...
En el caso de \maqam Bayati, a pesar de que su segundo \yins es \yins Nahawand en sol, se suele utilizar en la octava inferior \yins Rast en sol (es decir, con si\hflat\ en lugar de si$\flat$). El siguiente es un ejemplo de arranque en \maqam Bayati utilizando las notas por debajo de la tónica.
...
El descenso a tónica empleando un motivo melódico es una de las opciones más habituales. Por ejemplo:
...
El uso del trémolo para enfatizar un cierre es casi obligado en algunos estilos de ud como el árabe. El siguiente cierre combina el trémolo con un motivo melódico:
