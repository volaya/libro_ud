...
Es frecuente que la frase utilice las notas por debajo de la tónica, como en el siguiente ejemplo el el \maqam Rast:
...
Los patrones anteriores pueden emplearse no solo para arrancar un \taqsim, sino también para comenzar una frase dentro de este. Hay, sin embargo, algunos patrones que se utilizan habitualmente en este caso, pero que no aparecen como inicio del \taqsimb, tales como los que veremos a continuación.
...
\audioclip{inicio_a_ghammaz_1.mp3}{Inicio ascendente hasta \emph{ghammaz} 2}
...
El descenso a tónica empleando un motivo melódico es muy habitual. Por ejemplo:
...
Aunque menos frecuente, también es posible apoyarse en el \emph{ghammaz} en una octava inferior como nota previa antes de la tónica, que luego resuelve sobre esta.
