...
\section{La ornamentación y los \emph{maqamat}}
  ...
  El uso correcto de los ornamentos implica conocer en qué ocasiones es pertinente aplicarlos y cuándo no, para mantenerse dentro de las reglas estilísticas definidas por la tradición de la música árabe. Hay una relación directa entre este hecho y los distintos \emph{maqamat}, ya que, igual que un determinado ornamento puede o no ser adecuado en una parte de la melodía, también lo es en función de la nota del \emph{maqam} que se toque.
