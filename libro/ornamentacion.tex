...
Otra opción habitual es combinar la con un trémolo, de tal manera que se pulsan todas las notas. El patrón rápido ascendente se correspondería con un trémolo corto de tres notas.
...
El primero es de la pieza \emph{Lamma Bada Yatathanna}:
...
\audioclip{lamma_ornamentos.wav}{\emph{Lamma Bada Yatathanna} con y sin ornamentos}
...
\section{La ornamentación y los \emph{maqamat}}

  Vimos en la sección \ref{ornamentacion} las diversas maneras de ornamentar una melodía. Se comentó también entonces que el uso correcto de los ornamentos implica aprender en qué ocasiones es pertinente aplicarlos y cuándo no, habilidad que se adquiere a base de escuchar a otros interpretes e inferir de manera espontánea ese uso. Hay una relación directa entre este hecho y los distintos \emph{maqamat}, ya que, igual que un determinado ornamento puede o no ser adecuado en una parte de la melodía, también lo es en función de la nota del \emph{maqam} que se toque.
...
Como ejemplo de todo lo anterior, se muestra a continuación un fragmento de la canción \emph{***} en su forma original, y una posible interpretación con los ornamentos tambien transcritos en la partitura.
