...
Se realiza con movimiento de púa-contrapúa, es decir, con una pulsación descendente seguida de una ascendente.

\audioclip{doblenota.mp3}{Ornamentación: doble nota}
...
\audioclip{tremolo.mp3}{Ornamentación: trémolo}
...
\audioclip{octavas.mp3}{Ornamentación: octavas}
...
\audioclip{vibrato.mp3}{Ornamentación: vibrato}
...
\audioclip{glissando.mp3}{Ornamentación: \emph{glissando}}
...
\audioclip{mordente.mp3}{Ornamentación: mordente}
...
\audioclip{mordenteb.mp3}{Ornamentación: mordente con \emph{glissando}}
...
\audioclip{gruppeto.mp3}{Ornamentación: \emph{gruppeto}}
...
\audioclip{grupettob.mp3}{Ornamentación: \emph{grupetto} (pulsación alternativa)}
...
\audioclip{ornamento_farid.mp3}{Ornamentación: combinación de ornamentos}
...
\audioclip{tremoloflamenco.mp3}{Ornamentación: tremolo + melodía}
...
\begin{center}
\begin[line-width=12cm]{lilypond}
    \include "arabic.ly"
    \paper {
      #(define fonts
        (set-global-fonts
...
A continuación, un fragmento de la frase inicial de la canción \emph{Longa Farahfaza}, de Riad Al Sunbati:
...
\audioclip{lamma_ornamentos.wav}{\emph{Longa Farahfaza} con y sin ornamentos}
