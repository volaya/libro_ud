...
\include "arabic.ly"
notes = \relative do{
sol4 la si do si la sol fad mi re mi fad sol re sol2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol4 si la do si re do la si sol la fad
...
\include "arabic.ly"
notes = \relative do{
sol,4 la si do re mi fad sol la si do re
do si la sol fad mi re do si la sol2
sol4 si re sol sol,2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol,8 si la do si re do mi re fad mi sol fad la sol si la do si re do la si sol
la fa sol mi fa re mi do re si do la sol4 si8 re sol4 re8 si sol2
\bar "||"
}
...
notes = \relative do{
sol,8 si la do si re do mi re fad mi sol fad la sol si la do si re do la si sol
la fa sol mi fa re mi do re si do la sol4 si8 re sol4 re8 si sol4
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol,8  la si do  si do re mi re mi fad sol fad sol la si la si do re
re do si la do si la sol si la sol fad la sol fad mi
sol fad mi re fad mi re do mi re do si re do si la sol4
si8 re sol4 re8 si sol2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol,8 sol sol sol la la la la si si si si do do do do re re re re
mi mi mi mi fad fad fad fad sol sol sol sol sol sol sol sol
fad fad fad fad mi mi mi mi re re re re do do do do si si si si
...
\include "arabic.ly"
notes = \relative do{
sol,4 la8 si do re mi fad sol4 fad8 mi re do si la
sol4 si8 re sol4 re8 si sol2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol,4 la8 si do16 re mi fad sol4
sol8 la si do re16 do si la sol4
re8 sol fad mi re do si la sol4 sol' sol,2
\bar "||"
}
...
notes = \relative do{
\time 2/4
sol,8 la16 si la8 si16 do si8 do16 re do8 re16 mi re8 mi16 fasd mi8 fasd16 sol
fasd8 sol16 la sol4
sol8 fasd16 mi fasd8 mi16 re mi8 re16 do re8 do16 si do8 si16 la si8 la16 sol16
sol4 sol8 si16 re sol4 sol8 re16 si sol2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol8. la16 sisb8. do16 re8. do16 sisb8. la16
sol8. do16 sisb8. la16 sol8. fasd16 mi8. re16
sol8. sol16 fasd8. mi16 re8. do16 sisb8. la16
sol8. sol16 sol'8. sol16 sol,2
\bar "||"
}
...
\include "arabic.ly"
notes = \relative do{
sol,4 la8 sisb do16 re mi fasd sol4
sol8. la16 sisb8 do re16 do sisb la sol16 la sol8
re8. sol16 fasd8 mi re re16 do sisb8. la16
sol8. sisb16 re8 sol8 sol,2
\bar "||"
}
...
Además de tocar según lo indicado en la partitura, puede hacerse el ejercicio doblando la nota interior de cada 3 (con duración de corchea). Se haría con una pulsación descendente-ascendente, de manera que para cada trio de notas se tocarían cuatro en un patrón \downbow \downbow \upbow \downbow.
...
\include "arabic.ly"
notes = \relative do{
sol16 sol8 la16 sisb sisb8 do16 re re8 do16 sisb sisb8 la16
sol sol8 do16 sisb sisb8 la16 sol sol8 fasd16 mi mi8 re16
sol16 sol8 sol16 fasd16 fasd8 mi16 re16 re8 do16 sisb16 sisb8 la16
sol16 sol8 sisb16 re16 re8 sisb16 sol16 sol8 sol16 sol4
\bar "||"
}
...
Los ejercicios de esta sección trabajan las principales dificultades técnicas del ud. Buena parte de ellas están relacionadas con las formas de ornamentacion melódica que vimos en el capítulo \ref{ornamentacion}.
...
Algunos ejercicios cromáticos para ejercitar la independencia de los dedos de la mano izquierda. Se presentan todos en la posición 1 del mástil del ud, pero pueden desplazarse a otras posiciones.
...
Un ejercicio que trabaja especialmente los dedos meñique y anular.
...
\include "arabic.ly"
notes = \relative do{
dod, mi red mi dod mi red mi
fad la\5 sold la\5 fad la\5 sold la\5
lad dod do dod lad dod do^"etc..." dod
\bar "|"
\break
mi' reb mi dod mi reb mi dod
si sib si sold si sib si sold
fad fa fad mib fad fa fad^"etc..." mib
\bar "||"
}
...
re8 sol r8 sol fa r8 sol r8
la16 (sib) sol (la) fa (sol) mib (fa) re (mib) do (re) sib (do) la (sib)
