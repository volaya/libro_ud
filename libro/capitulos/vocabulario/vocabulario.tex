...
Dividiremos los patrones de este capítulo en tres grupos principales: inicios, cierres, y secuencias melódicos.

Los ejemplos comentados a continuación se presentan en su  mayoría en los \maqamaat Rast y Nahawand, salvo cuando se indica lo contrario. El objetivo no es solo ofrecer una colección de fragmentos y frases, sino presentar en base a ellos las formas más habituales en las que se presentan como elementos de una pieza, para así ayudar a una mejor comprensión de la estructura de un \taqsim y de otras frases similares. Junto a ellos, se incluyen secciones particulares para algunos de los \maqamaat más habituales, con una pequeña colección de frases para cada uno de ellos.
...
\newbeginning{}
El siguiente inicio arranca en la octava superior, y se utilizaría para abrir una frase intermedia, una vez que se ha llegado a esa altura en el desarrollo melódico del \taqsimb. No se utilizaría para dar comienza al \taqsim en sí.
...
Las secuencias melódicas y frases de esta sección no se asocian, por lo general, a un \maqam determinado, y pueden utilizarse en cualquiera de ellos, sin más que adaptar los intervalos y las notas correspondientes.
...
El siguiente ejemplo es un patrón ascendente que utiliza la frase anterior tanto en la segunda como en la primer cuerda.
...
Jugando con las tres frases anteriores, un inicio y un cierre, y añadiendo algunas otras notas para conectar todo ello, podemos ya hacer frases más largas como la siguiente.
