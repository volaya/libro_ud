...
En el apartado \ref{ritmotaqsim} se habló de la componente rítmica de un \taqsimb. Para cada una de sus frases y secciones, el <<pulso>> que mencionabamos entonces vendrá en general definido por el del patrón con el que arranca dicha frase. Modificando este, podemos dar un aire distinto a una sección.

Por ejemplo, el inicio sencillo mostrado anteriormente tiene un sentir rítmico muy distinto si se cambia la acentuación y el uso de la nota pedal, como en el el siguiente ejemplo:
...
\include "arabic.ly"
notes = \relative {
\tuplet 3/2 { la,16 (sib do)} re4\fermata
...
\include "arabic.ly"
notes = \relative {
sol,16 sib do re re re re re re re, re' re re, re' re re, re' re mib mib re mib4 re2
