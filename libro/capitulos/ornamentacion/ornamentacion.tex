...
La partitura cumple la función del texto en una obra de teatro, que indica al actor las frases que debe decir, pero no (salvo indicaciones puntuales) el lenguaje corporal o la entonación. Es decir, que indica \emph{qué} decir, pero no \emph{cómo} decirlo.
