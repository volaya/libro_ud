...
La partitura cumple la función del texto en una obra de teatro, que indica al actor las frases que debe decir, pero no (salvo indicaciones puntuales) el lenguaje corporal o la entonación.
...
Aunque en la música occidental, en especial en la música clásica, también hay lugar para que el interprete añada su propia identidad en la interpretación, el margen que permite es más reducido, o al menos no es necesario añadir esos elementos. En la música árabe por el contrario, es obligatorio no seguir la partitura de manera literal, sino construir sobre ella una interpretación más rica y elaborada.
