...
Es decir\footnote{Por convención, la música de ud se escribe en clave de sol, una octava por encima del sonido real de la nota, de la misma forma que sucede para la música de guitarra. El número ocho situado bajo el símbolo de la clave indica este hecho. Los dos fragmentos bajo este párrafo son equivalentes, siendo el de la derecha el que se utiliza en el caso del ud, para evitar de este modo la necesidad de añadir un número excesivo de líneas adicionales.\\
...
Según escribió el filósofo al-Farabi en su libro \emph{Kitab al-musiqa al-kabir} (\emph{El gran libro de la musica}), uno de los principales tratados sobre la música árabe, escrito en el siglo X, <<los ornamentos deben aportar a la melodía brillo, elegancia, abundancia y belleza>>.
...
Asimismo, el uso arbitrario de ornamentos puede enriquecer la interpretación, pero resultar extraño para el oyente entrenado si esa forma no sigue lo habitual en algún estilo o mezcla la forma de varios de ellos. La ornamentación puede entenderse como algo semejante al acento que tiene el hablante de un determinado idioma, y la anterior circunstancia sería como hablar mezclando varios acentos. No es algo \emph{per se} incorrecto, pero resulta extraño para quien conoce el idioma y las particularidades de su pronunciación.
...
Es habitual el variar la posición de la \emph{risha} para la realización del trémolo, situándola más perpendicular a las cuerdas, de forma que el contacto con estas se realice  con la parte frontal de la púa.

\subsubsection{Octavas}

Otra técnica empleada con frecuencia en el ud es la duplicación de la línea melódica utilizando notas una octava por debajo (en cuyo caso recibe el nombre de \emph{qarar}) o por encima (\emph{jawab}). En el siguiente fragmento se muestra un ejemplo de la primera de estas técnicas. El primer compás representa la melodía sin ornamento, y el segundo, la misma melodía ornamentada.
...
El vibrato consiste en un oscilación rapida de la altura de la nota, y se produce haciendo vibrar la mano izquierda sobre el mastil repetidamente, una vez la nota está pulsada.

El movimiento que produce el vibrato se realiza principalmente con el codo, moviendo todo el antebrazo, ene special cuando el vibrato es intenso. No se realiza con la muñeca o los dedos, como es habitual en la guitarra. El movimiento de las yemas de los dedos se produce en la dirección que define la propia cuerda.

El dedo pulgar debe situarse en una posición sólida en la parte superior del mastil, con el fin de tener buena sujeción.
...
La pulsación del motivo melódico admite diversas alternativas. La más habitual es tocar la primera nota con un golpe descendente de pua, la primera de las notas cortas con uno ascendente, ligar esta con las siguientes dos, y finalmente tocar la última nota con una nueva pulsación descendente. Es decir:
...
\subsubsection{Secuencias melódicas}
